...
const NuevoInventario = () => {
  ...
  const validate = () => {
    ...
    if (!formData.nombre) {
      ...
      tempErrors.nombre = 'Nombre no puede contener caracteres especiales';
    ...
    if (!formData.descripcion) {
      ...
      tempErrors.descripcion = 'Descripción debe tener al menos 10 caracteres';
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/inventarios', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        console.error('Error creating inventory item:', response.statusText);
      }
    } catch (error) {
      ...
      <div className="container mt-5">
        <div className="flex items-center justify-center p-12">
          <div className="mx-auto w-full max-w-[550px]">
            <h2 className="text-center mb-4">Nuevo Inventario</h2>
